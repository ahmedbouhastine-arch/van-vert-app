        ...
        >
            <Card className="bg-gray-900/50 backdrop-blur-sm border-white/10 shadow-2xl shadow-blue-500/10 rounded-xl">
                ...
                <CardContent>
                    ...
                    <Button variant="outline" className="w-full bg-gray-800/60 border-white/20 text-white hover:bg-gray-700/60 hover:text-white font-semibold py-3 rounded-lg transition-all" onClick={handleGoogleLogin} disabled={isSubmitting}>
